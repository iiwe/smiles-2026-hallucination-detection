...
def split_data(
    ...
    for train_mask, val_mask in skf.split(idx_train_val, y[idx_train_val]):
        idx_train_fold = idx_train_val[train_mask]
        idx_val_fold = idx_train_val[val_mask]
        
        folds.append((idx_train_fold, idx_val_fold, idx_test))
